...
public class DigitsToLetterDemo1 {

    private final static Map<String, List<String>> digitsMap;
    ...
    public static void digitsToLetters(){
        ...
        while(true){
            digits=input.next();
            if ("exit".equals(digits)){
                input.close();
            }else if(!digits.matches("[0-9]{1,2}")){
